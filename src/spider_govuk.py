...
class MySpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # caratteri = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "z"]
        # for i in caratteri:
        #     yield scrapy.Request('https://find-and-update.company-information.service.gov.uk/search/companies?q=' + i, self.parse)
        # yield scrapy.Request('https://find-and-update.company-information.service.gov.uk/search/companies?q=p', self.parse)
    ...
    def information_companies(self, response):
        ...
        item['registered_office_address'] = self.split_and_replace(
            response.xpath('//div[@class="govuk-tabs__panel"]/dl/dd/text()').get())
        ...
        item['company_creation_date'] = self.split_and_replace(
            response.xpath('//*[@id="company-creation-date"]/text()').get())
